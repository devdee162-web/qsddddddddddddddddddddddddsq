# ==============================================================================
#  Zcord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Zcord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Zcord-Client"
...
Write-Host "  ║      ZCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Zcord désinstallé avec succès !                 │" -ForegroundColor Green
