# ==============================================================================
#  Zcord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Zcord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Zcord
$ZcordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$ZcordPatcher = $ZcordPatcher.Replace("\", "\\")
...
// Injection Zcord
try {
    require(\"$ZcordPatcher\");
} catch (e) {
    console.error(\"Zcord injection failed:\", e);
