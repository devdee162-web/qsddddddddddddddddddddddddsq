...
[[ -z "$NOTES" ]] && NOTES="Zcord $VERSION"

# ── Config Gitea ──────────────────────────────────────────────────────────────
GITEA_URL="https://source.zcord.st"
GITEA_REPO="zcord/zcord"
...
DIST_ZIP="$OUT_DIR/zcord-dist.zip"
INSTALLER_EXE="$OUT_DIR/Zcord-Installer.exe"
...
# ── 5. Compiler Zcord-Installer.exe ──────────────────────────────────────
echo ""
...
echo " [5/8] Zcord-Installer.exe cree ($INSTALLER_SIZE octets)"

# ── 6. Créer zcord-dist.zip ──────────────────────────────────────────────
echo ""
...
echo " [6/8] zcord-dist.zip cree ($DIST_ZIP_SIZE octets)"
...
cat > "$VERSION_JSON" <<EOF
{
  ...
  "installerUrl": "$GITEA_URL/$GITEA_REPO/releases/download/v$VERSION/Zcord-Installer.exe",
  "distUrl": "$GITEA_URL/$GITEA_REPO/releases/download/v$VERSION/zcord-dist.zip",
...
upload_asset "$INSTALLER_EXE" "Zcord-Installer.exe" "application/octet-stream"
upload_asset "$DIST_ZIP"      "zcord-dist.zip"      "application/zip"
