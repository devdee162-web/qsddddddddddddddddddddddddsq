...
`;
    ...
    writeFileSync("src/zcordplugins/autoTranslateZcord/index.ts", fileHeader + entriesStr + fileFooter, "utf8");
    console.log("Done! Written all translations to autoTranslateZcord/index.ts.");
}
