...
function getGitHash() {
    if (process.env.ZCORD_HASH) return process.env.ZCORD_HASH;
    try {
...
export const globPlugins = kind => ({
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "import-plugins" }, async () => {
            const pluginDirs = ["plugins/_api", "plugins/_core", "plugins", "userplugins", "zcordplugins", "zcordplugins/_api"];
            ...
            // ─── External User Plugins (~/Documents/Zcord/userplugins/) ───────────
            // Scan and auto-create the external userplugins directory.
            const externalUserPluginsDir = join(homedir(), "Documents", "Zcord", "userplugins");
            try {
...
export const gitRemotePlugin = {
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "git-remote" }, async () => {
            let remote = process.env.ZCORD_REMOTE;
            if (!remote) {
                try {
...
export const commonOpts = {
    ...
    alias: {
        ...
        "@zcordplugins": "./src/zcordplugins",
        "@equicordplugins": "./src/plugins",
        "@Zcord/types/webpack/common": "./src/webpack/common",
        "@Zcord/types/webpack": "./src/webpack/webpack",
        "@Zcord/types/utils": "./src/utils",
        "@Zcord/types/components": "./src/components",
        "@Zcord/types/api": "./src/api",
        "@Zcord/types/plugins": "./src/plugins",
        "@Zcord/types": "./src",
