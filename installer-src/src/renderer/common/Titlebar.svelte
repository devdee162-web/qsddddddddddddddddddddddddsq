<script>
    ...
    onMount(async () => {
        ...
        const options = {
            hostname: "source.zcord.st",
            path: "/api/v1/repos/zcord/zcord/releases/latest",
            method: "GET",
            rejectUnauthorized: false,
            headers: {"User-Agent": "zcord-installer"}
        };
...
<header class="titlebar {macButtons === true ? "type-mac" : "type-standard"}">
    <span class="title">Zcord Installer v{displayVersion}</span>
