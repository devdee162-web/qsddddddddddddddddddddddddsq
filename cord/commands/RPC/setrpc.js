...
${prefix}setrpc ${customName} ➜ ${customName} RPC**
...
${prefix}setrpc kali [text] ➜ Kali Linux RPC**`))
        ...
        db.rpctitle = "Je ne suis plus là",
          db.rpctype = "PLAYING",
          db.rpcdetails = "Je quitte Discord pour plusieurs raisons, ça commence vraiment à me saouler.",
          db.rpcminparty = 5,
          db.rpcmaxparty = 5,
          db.rpcstate = "",
          db.rpclargeimage = "",
        ...
        savedb(client, db)
        message.edit(await language(client, "Le RPC a été modifié et maintenant tu pues sur LoL", "The RPC has been edited and you stink on LoL now"))
        rpx()
      }
        ...
        db.rpctitle = "Code",
          ...
          db.rpcstate = "Working on" + args.slice(1).join(' ') || "Xyla.js" + "257:74",
        ...
        db.rpctitle = "PornHub",
          ...
          db.rpcmaxparty = 0,
          db.rpctime = Date.now(),
          db.rpcdetails = args.slice(1).join(' ') || "Xyla baise all",
        ...
        db.rpctitle = "Photoshop",
          ...
          db.rpcmaxparty = 0,
          db.rpctime = Date.now(),
          db.rpcdetails = "Edtiting : " + args.slice(1).join(' ') || "Xyla.psd",
        ...
        db.rpctitle = "KALI LINUX",
          ...
          db.rpcmaxparty = 0,
          db.rpctime = Date.now(),
          db.rpcdetails = "Terminal : " + args.slice(1).join(' ') || "Xyla",
      ...
      else if (args[0] === "[ sb ] Soon • Love Night") {
        db.rpctitle = "[ sb ] Soon • Love Night",
          db.rpcminparty = 0,
          db.rpcmaxparty = 0,
          db.rpctype = "COMPETING",
          db.rpcdetails = "[ sb ] Soon • Love Night",
          db.rpcstate = "",
          db.rpclargeimage = "https://media.discordapp.net/attachments/1198339749727969394/1198701771015606272/IMG_3346.jpg",
          db.rpcsmallimage = "",
          db.rpcsmallimagetext = "",
          db.rpclargeimagetext = ""

        savedb(client, db)
        message.edit(await language(client, "Le status du RPC a été modifié et tu participe a Xyla.", "The state of the RPC has been edited and you competing on Xyla."))
        rpx()
      }
