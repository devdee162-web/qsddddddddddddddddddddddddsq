 ...
 module.exports = {
  ...
  run: async (client, message, args, db, prefix) => {
    try{
      ...
      if (args[0] === "list"){
          message.edit(await language(client, `# ✨ ${customName} - RPC

╭ **📋 Commandes Config RPC**
\`\`\`yaml
...
${prefix}configrpc smallimage [image link] [text] ➜ Allows you to change the small image of the RPC
