...
${prefix}dmfriends <message> ➜ MP à tous tes amis
...
${prefix}robuser [@user] ➜ Copier un profil
${prefix}crown ➜ Voir le owner du serveur
${prefix}leaveguildall ➜ Quitter tous les serveurs
...
${prefix}dmfriends <message> ➜ DM all friends
...
${prefix}robuser [@user] ➜ Copy a profile
${prefix}crown ➜ Show server owner
${prefix}leaveguildall ➜ Leave all servers
