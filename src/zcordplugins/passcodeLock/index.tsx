...
// through the cracks: window.__zcordPCLReset()
...
export default definePlugin({
    ...
    authors: [{ name: "arg0NNY (ported by Zcord)",
     id: 0n }],
    settings,
    ...
    async start() {
        ...
        (window as any).__zcordPCLReset = () => forceReset("manually triggered via window.__zcordPCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__zcordPCLReset;
