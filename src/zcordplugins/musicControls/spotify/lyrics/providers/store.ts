...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@zcordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@zcordplugins/musicControls/spotify/SpotifyStore";
