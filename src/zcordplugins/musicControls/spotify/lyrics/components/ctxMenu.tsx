...
import { providers } from "@zcordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@zcordplugins/musicControls/spotify/lyrics/providers/store";
