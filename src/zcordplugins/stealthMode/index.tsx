...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in Zcord Settings.",
    authors: [{ name: "Zcord",
     id: 0n }],
    required: true,
    managedStyle: style,
    ...
    stop() {
        document.body.classList.remove("zcord-stealth");
    },
});
