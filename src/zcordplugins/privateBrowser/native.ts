...
export function setup() {
    ...
    // ZcordNews, YoutubePlayer, QxChat, etc.  We must only forward
...
const EXTENSIONS_DIR = path.join(app.getPath("userData"), "zcord-extensions");
 ...
 * The files are copied to the zcord-extensions userData directory,
