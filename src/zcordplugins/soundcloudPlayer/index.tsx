...
import { SafeDynamicIsland } from "@zcordplugins/DynamicIslande";
                ...
                if (props) {
                    ...
                    if (Array.isArray(props.activity?.metadata?.button_urls)) {
                        for (const u of props.activity.metadata.button_urls) {
                            if (typeof u === "string" && u.includes("zcord.st/listen")) return u;
                        }
                    }
                }
                fiber = fiber.return;
...
export default definePlugin({
    ...
    start() {
        ...
        documentClickHandler = (e: MouseEvent) => {
            ...
            if (href && href.includes("zcord.st/listen?")) {
                e.preventDefault();
                e.stopPropagation();
