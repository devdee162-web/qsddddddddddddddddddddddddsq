...
function injectHypeSquadChangerIntoNativePanel() {
    ...
    if (editingPanel && !document.getElementById("zcord-hypesquad-changer-modal-container")) {
        const scroller = editingPanel.querySelector("[class*='content__523e1'], [class*='scroller_'], [class*='scrollRegion_'] > div");
        if (scroller) {
            const container = document.createElement("div");
            container.id = "zcord-hypesquad-changer-modal-container";
    ...
    if (settingsView && !document.getElementById("zcord-hypesquad-changer-container")) {
        ...
        if (isProfileTab) {
            ...
            if (contentColumn) {
                ...
                if (!targetParent.querySelector("#zcord-hypesquad-changer-container")) {
                    const container = document.createElement("div");
                    container.id = "zcord-hypesquad-changer-container";
...
function stopDomObserver() {
    ...
    for (const id of ["zcord-hypesquad-changer-container", "zcord-hypesquad-changer-modal-container"]) {
