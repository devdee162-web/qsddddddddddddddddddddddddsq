...
import { ThemesTab, ChangelogTab, PluginsTab, BackupAndRestoreTab, UpdaterTab, VencordTab, LanguageTab } from "@components/settings/tabs";
...
const TABS: TabDef[] = [
    ...
    },
    {
        ...
        description: "Change Zcord's interface language",
    },
];
...
function ZcordModalInner({ onClose, initialTab = null }: { onClose: () => void; initialTab?: string | null; }) {
    ...
    let TabContent = null;
    switch (activeTab) {
        case "zcord": TabContent = <VencordTab />; break;
        ...
        <div className="nc-modal-root theme-dark" data-theme="dark" style={{ color: "var(--text-normal, #dbdee1)" }}>
            ...
            <div className="nc-modal-sidebar">
                <div className="nc-modal-sidebar-header">
                    ...
                    <span>Zcord Settings</span>
                </div>
                <div className="nc-modal-sidebar-nav" style={{ padding: "6px 0" }}>
                    {TABS.map(tab => (
                        <div
                            key={tab.id}
                            className={`nc-modal-sidebar-item${activeTab === tab.id || hovered === tab.id ? " nc-modal-sidebar-item--active" : ""}`}
