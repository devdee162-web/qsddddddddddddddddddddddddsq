...
import { forceServerListRerender } from "@zcordplugins/_utils/serverListRefresh";
...
export default definePlugin({
    ...
    start() {
        ...
        FluxDispatcher.subscribe("ZCORDNEWS_TOGGLE", handleOtherPluginToggle);
    },
    ...
    stop() {
        ...
        FluxDispatcher.unsubscribe("ZCORDNEWS_TOGGLE", handleOtherPluginToggle);
    }
});
