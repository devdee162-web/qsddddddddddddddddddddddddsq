...
/**
 * Retrieves saved messages for a channel within a specific time window [start, end].
 * Used when loading a batch of messages to only inject deleted messages that belong
 * to that exact time window — preventing deleted messages from other periods leaking in.
 */
