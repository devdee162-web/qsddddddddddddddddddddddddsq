...
const ZcordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(ZcordDir, "Uninstall Zcord.exe"));
...
export const USER_AGENT = `Zcord/${app.getVersion()} (https://git.${domain}/zcord/zcord)`;
