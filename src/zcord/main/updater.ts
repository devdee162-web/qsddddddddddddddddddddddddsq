...
// Zcord native defaults — no external prefs file, always on
const ZCORD_PREFS = { defaultPlugins: true, autoUpdate: false } as const;

export const installerPrefs = ZCORD_PREFS;

handle(IpcEvents.GET_INSTALLER_PREFS, () => ZCORD_PREFS);
