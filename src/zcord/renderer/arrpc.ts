...
import { Logger } from "@Zcord/types/utils";
import { findLazy, onceReady } from "@Zcord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Zcord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("ZcordRPC", "#5865f2");
