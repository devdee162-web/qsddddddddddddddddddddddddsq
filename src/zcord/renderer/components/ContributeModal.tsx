...
import { Flex } from "@Zcord/types/components/Flex";
import { Heading } from "@Zcord/types/components/Heading";
import { Paragraph } from "@Zcord/types/components/Paragraph";
import { copyWithToast } from "@Zcord/types/utils/discord";
import { ModalContent, ModalFooter, ModalHeader, ModalProps, ModalRoot } from "@Zcord/types/utils/modal";
import { Button, React } from "@Zcord/types/webpack/common";
import { t } from "../../../zcordplugins/autoTranslateZcord";
            ...
            <ModalHeader separator={false} style={{ paddingTop: "24px", paddingBottom: "12px" }}>
                <Flex direction={Flex.Direction.VERTICAL} align={Flex.Align.CENTER} style={{ width: "100%" }}>
                    <Heading level={2} variant="heading-xl/bold" style={{ color: "#ffffff" }}>
                        {t("Support Zcord Project")}
                    </Heading>
                    <Paragraph style={{ textAlign: "center", color: "#dbdee1", fontSize: "13px", marginTop: "6px", maxWidth: "440px", lineHeight: "1.4" }}>
                        {t("Zcord is an independently developed project. Your donations directly contribute to server maintenance, developing new features, and ongoing updates.")}
                    </Paragraph>
                </Flex>
            </ModalHeader>
            ...
            <ModalContent style={{ padding: "16px 24px 24px 24px" }}>
                ...
                <div style={{
                    ...
                    <Paragraph size="xs" style={{ fontSize: "12px", margin: 0, color: "#dbdee1" }}>
                        {t("Thank you for supporting the Zcord project!")}
                    </Paragraph>
                </div>
            </ModalContent>
