...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Zcord/types/components";
import { FluxDispatcher, InviteActions } from "@Zcord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Zcord and Zcord are fully up to date. You can get help in our{" "}
