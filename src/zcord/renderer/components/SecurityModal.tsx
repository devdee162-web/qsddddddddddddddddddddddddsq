...
import { Button, Flex, Heading, Paragraph } from "@Zcord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot } from "@Zcord/types/utils/modal";
import { React } from "@Zcord/types/webpack/common";
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => VencordNative.native.openExternal("https://discord.gg/zcord")}
                            >
                                discord.gg/zcord
                            </span>
                        </li>
