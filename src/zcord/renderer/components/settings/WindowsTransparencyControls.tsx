...
import { Heading, Paragraph } from "@Zcord/types/components";
import { Margins } from "@Zcord/types/utils";
import { Select } from "@Zcord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Zcord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
