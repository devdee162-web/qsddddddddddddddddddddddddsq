...
import { useState } from "@Zcord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Zcord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Zcord minimized when starting with system"}
