...
import { BaseText, Button, FormSwitch } from "@Zcord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Zcord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`zcord://assets/${asset}?v=${version}`}
                    alt=""
