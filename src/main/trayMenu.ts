...
function createZcordMenuItems(): MenuItemConstructorOptions[] {
    return [
        {
            label: "Zcord",
            submenu: [
                ...
                {
                    label: cachedUpdateAvailable ? "Update Zcord" : "Check for Updates",
...
export function patchTrayMenu(): void {
    // No longer patching tray menu — Zcord manages its own tray in patcher.ts
}
