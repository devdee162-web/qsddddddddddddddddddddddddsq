...
export const settings = definePluginSettings({
    format: {
        ...
        default: "{zcordIcon} Zcord {zcordVersion} ({zcordHash})",
        restartNeeded: true
    }
});
...
export const settingVariables = [
    ...
    "",
    "Zcord Variables:",
    "{zcordIcon} / {equicordIcon} - Zcord icon",
    "{zcordName} / {equicordName} - Client name (Zcord)",
    "{zcordVersion} / {equicordVersion} - Version of Zcord (e.g. 1.26.2)",
    "{zcordHash} / {equicordHash} - Zcord build hash",
    "{zcordPlatform} / {equicordPlatform} - Platform (e.g. Dev Build)",
    "",
    "Client Variables:",
