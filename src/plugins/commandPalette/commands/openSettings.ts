...
export const DISCORD_SETTINGS_ROUTES: SettingsRoute[] = [
    ...
    { route: "equicord_main", label: "Zcord", keywords: ["zcord", "vencord", "equicord", "client"] },
    { route: "equicord_plugins", label: "Zcord Plugins", keywords: ["plugins", "zcord"] },
    { route: "equicord_themes", label: "Zcord Themes", keywords: ["themes", "css", "zcord"] },
    { route: "equicord_updater", label: "Zcord Updater", keywords: ["update", "zcord"] },
    { route: "equicord_changelog", label: "Zcord Changelog", keywords: ["changelog", "news", "zcord"] }
];
