...
export default definePlugin({
    ...
    patches: [
        {
            // Do not use ",updateSetting:" — that also matches Discord's settings
            // layout module and crashes AppLayer with true.useSetting / true.supports.
            find: "SELECTIVELY_SYNCED_USER_SETTINGS_UPDATE",
            replacement: [
                {
