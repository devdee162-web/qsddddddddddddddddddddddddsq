...
export const enum IpcEvents {
    ...
    GET_INSTALLER_PREFS = "ZcordGetInstallerPrefs",
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "ZcordSetWindowBackgroundMaterial",
    ...
    // Zcord Updater â€” tÃ©lÃ©charge un exe depuis une URL et le lance
    ZCORD_DOWNLOAD_AND_RUN = "ZcordDownloadAndRun",
    ZCORD_UPDATE_STATUS = "ZcordUpdateStatus",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "ZcordCheckVBCable",
    INSTALL_VB_CABLE = "ZcordInstallVBCable",

    // Relaunch de l'app Electron
    RELAUNCH_APP = "ZcordRelaunchApp",
    ...
    SET_CONTENT_PROTECTION = "ZcordSetContentProtection"
}
