...
export function ZcordIcon(props: IconProps) {
    return (
        <svg
            ...
            className={classes(props.className, "zc-logo-icon")}
            role="img"
            aria-hidden="true"
        >
            <defs>
                <linearGradient id="zc-logo-orange" x1="0" y1="0" x2="1" y2="1">
                    <stop offset="0%" stopColor="#f5b48a" />
                    <stop offset="100%" stopColor="#e85d3a" />
                </linearGradient>
            </defs>
            <polygon fill="url(#zc-logo-orange)" points="6,8 34,8 26,20 0,20" />
            <polygon fill="url(#zc-logo-orange)" points="6,8 18,8 4,40 0,32" />
            <polygon fill="#fff" points="36,8 52,8 44,20 28,20" />
            <polygon fill="url(#zc-logo-orange)" points="50,8 62,8 54,20 42,20" />
            <polygon fill="#fff" points="26,20 40,20 22,56 8,56" />
            <polygon fill="#fff" points="8,44 54,44 46,56 0,56" />
            <polygon fill="url(#zc-logo-orange)" points="26,44 46,44 38,56 18,56" />
        </svg>
    );
}
