 ...
 * video in https://source.zcord.st/zcord/zcord-tutorials/src/branch/main/videos
 *
...
/**
 * Set of plugin names that have a tutorial video available in zcord-tutorials.
