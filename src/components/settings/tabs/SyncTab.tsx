...
const cloudBackendOptions = [
    { label: "Zcord Cloud", value: "https://api.zcord.st/" },
...
const BADGE_OPTIONS: Array<{ label: string; value: BadgeSource }> = [
    { label: "Zcord Badges", value: "zcord" },
        ...
        <div style={{ marginBottom: 16 }}>
            <FormSwitch
                ...
                description={isEnabled
                    ? t("Your custom profile is synced. Other Zcord users can see your profile, and you can see theirs.")
                    : t("Enable to share your custom profile with other Zcord users and see their profiles.")}
                disabled={busy}
            />
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Zcord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.")}
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                {t("We use our own Zcord Cloud backend with enhanced features.")}
                {" "}
            ...
            <div className={Margins.bottom8}>
                <SafeSearchableSelect
                    ...
                    renderOptionPrefix={o => {
                        if (o?.value?.includes("zcord")) return <ZcordIcon />;
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Synchronize your Zcord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.")}
            </Paragraph>
