        ...
        <SettingsTab>
            ...
            <div className={Margins.bottom8}>
                <SafeSearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("zcord") ? <ZcordIcon /> : o?.value?.includes("equicord") ? <EquicordIcon /> : <VencordIcon />}
                />
            </div>
