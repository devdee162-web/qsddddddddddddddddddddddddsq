<div align="center">
  <img src="https://zcord.st/image.png" width="96" height="96" alt="Zcord Logo">

# Zcord

**A custom Discord client built for people who actually care about how Discord runs.**

[![Telegram](https://img.shields.io/badge/Telegram-Join%20us-26A5E4?logo=telegram&logoColor=white)](https://t.me/zcordoff)
[![License](https://img.shields.io/badge/license-GPL%20v3-a855f7)](./LICENSE)
[![Platform](https://img.shields.io/badge/platform-Windows-3b82f6.svg?logo=windows\&logoColor=white)](https://source.zcord.st/zcord/zcord)
[![Website](https://img.shields.io/badge/website-zcord.st-5865F2?logo=googlechrome\&logoColor=white)](https://zcord.st)

---

</div>

Zcord is a fork of Equicord, which itself builds on top of Vencord. We stripped out the obfuscation, cleaned things up, added our own improvements, and kept what works. No bloat, no nonsense.
...
```bash
git clone https://source.zcord.st/zcord/zcord.git
cd zcord
pnpm install
pnpm build
```
...
https://source.zcord.st/zcord/zcord

---

## Credits

Zcord wouldn't exist without [Equicord](https://github.com/Equicord/Equicord) and [Vencord](https://github.com/Vendicated/Vencord). A huge chunk of what makes this work comes directly from their projects. We're fully aware of that and genuinely appreciate everything they've built — we're just taking it in a different direction. Big thanks to everyone who's contributed to both.
...
*Zcord is not affiliated with Discord Inc. in any way.*
